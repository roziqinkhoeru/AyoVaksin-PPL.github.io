...
!(function (e, t) {
  ...
  return (
    ...
    function t(a) {
      var l = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        b = function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            i = t.target,
            r = function () {
              var t = { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight, left: 0, top: 0, right: 0, bottom: 0 },
                i = void 0,
                r = void 0;
              if (S.container)
          ...
          return new c(function (e) {
            if (i && -1 === O.indexOf(i)) e(j);
              ...
              if (T.zoomed) e(j);
                ...
                if (
                  (T.original.dispatchEvent(m("medium-zoom:open", { detail: { zoom: j } })),
          ...
          return new c(function (e) {
            if (!A && T.original) {
              (A = !0),
                ...
                T.template && ((T.template.style.transition = "opacity 150ms"), (T.template.style.opacity = 0)),
                T.original.dispatchEvent(m("medium-zoom:close", { detail: { zoom: j } })),
                T.zoomed.addEventListener("transitionend", function t() {
                  T.original.classList.remove("medium-zoom-image--hidden"),
                    ...
                    T.original.dispatchEvent(m("medium-zoom:closed", { detail: { zoom: j } })),
                    (T.original = null),
                    (T.zoomed = null),
                    (T.zoomedHd = null),
                    (T.template = null),
      ...
      "[object Object]" === Object.prototype.toString.call(a) ? (S = a) : (a || "string" == typeof a) && v(a), (S = e({ margin: 0, background: "#fff", scrollOffset: 40, container: null, template: null }, S));
      ...
      var j = { open: b, close: E, toggle: w, update: p, clone: g, attach: v, detach: h, on: z, off: y, getOptions: L, getImages: H, getZoomedImage: C };
      return j;
    }
  );
});
